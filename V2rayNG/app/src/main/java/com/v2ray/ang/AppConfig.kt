...
object AppConfig {
    ...
    const val PREF_MANUAL_VARIANTS_JSON = "pref_manual_variants_json"
    const val PREF_RESET_MANUAL_VARIANTS = "pref_reset_manual_variants"
    ...
    const val APP_URL = "$GITHUB_URL/Girikhi/v2rayNG-Auto"
    const val APP_API_URL = "https://api.github.com/repos/Girikhi/v2rayNG-Auto/releases"
    const val APP_ISSUES_URL = "$APP_URL/issues"
    const val APP_WIKI_MODE = "$APP_URL/wiki/Mode"
    const val APP_PRIVACY_POLICY = "$GITHUB_RAW_URL/Girikhi/v2rayNG-Auto/refs/heads/codex/v2.2.5-auto/CR.md"
